...
using Technovert.BankApp.DataAccess.Repository;*/
...
namespace Technovert.Bankapp.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBank<Bank>, RepositoryBank>();
            services.AddTransient<BankService, BankService>();
            services.AddControllers();
